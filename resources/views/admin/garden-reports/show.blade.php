                ...
                <div class="p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="image-gallery-container mt-2" style="display: flex; gap: 10px; flex-wrap: wrap;">
                            ...
                            <div class="gallery-image-thumbnail" data-index="{{ $index }}" data-src="{{ $image->public_url }}" style="width: 130px; height: 130px; border: 1px solid #ccc; border-radius: 8px; overflow: hidden; cursor: pointer;">
                                <img src="{{ $image->public_url }}" alt="Imagen {{ $index + 1 }}" style="width: 100%; height: 100%; object-fit: cover;">
                            </div>
                            @endforeach
                        </div>
                    </div>
                                ...
                                <div class="modal-body p-0">
                                    ...
                                    <div class="gallery-thumbnails">
                                        ...
                                        <div class="gallery-thumbnail {{ $index === 0 ? 'active' : '' }}"
                                             ...
                                             data-image-src="{{ $image->public_url }}">
                                            <img src="{{ $image->public_url }}" alt="Miniatura {{ $index + 1 }}">
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
