    ...
    <div class="col-12">
        <div class="card mb-4 mx-4">
            <div class="card-header pb-0">
                <h5 class="mb-0">Crear Nueva Suscripción</h5>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
                <form action="{{ route('admin.subscriptions.store') }}" method="POST" class="p-4">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn bg-gradient-primary">Crear Suscripción</button>
