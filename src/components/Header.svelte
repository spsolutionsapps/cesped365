...
<header class="z-10 py-4 bg-white">
  <div class="container flex items-center justify-between h-full px-6 mx-auto text-primary-600">
    <!-- Mobile hamburger (visible solo en viewport &lt; lg) -->
    <button
      type="button"
      class="flex items-center justify-center shrink-0 p-2 mr-3 -ml-1 rounded-md lg:hidden text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500"
