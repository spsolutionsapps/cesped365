...
<section class="py-20" id="beneficios">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid lg:grid-cols-2 gap-16 items-center">
      <!-- Left side - Content -->
      <div>
        <h2 class="text-2xl md:text-[34px] font-bold text-gray-900 mb-6">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 flex flex-col">
          ...
          <p class="text-gray-600 mb-6 text-xl">Hasta 500 m²</p>
          <div class="mt-auto">
            <button class="w-full bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-full font-semibold transition-all shadow-lg flex items-center justify-center gap-2">
              Pagar
        ...
        <!-- Card 2: Residencial (Highlighted) -->
        <div class="bg-[#0b3d2c] rounded-2xl shadow-lg p-6 flex flex-col relative overflow-hidden">
          <div class="absolute inset-0 opacity-5">
            <svg class="w-full h-full" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M100 20C100 20 40 60 40 120C40 160 68 188 100 188C100 188 100 100 100 20Z" fill="white"/>
              <path d="M100 20C100 20 160 60 160 120C160 160 132 188 100 188C100 188 100 100 100 20Z" fill="white"/>
            </svg>
          </div>
          <h3 class="text-xl font-bold text-white mb-4 relative z-10">Residencial</h3>
          <div class="mb-6 relative z-10">
            <span class="text-3xl font-bold text-white">$60.000</span>
            <span class="text-white/80">/mes</span>
          </div>
          <p class="text-white/90 mb-6 relative z-10 text-xl">500 a 2.500 m²</p>
          <div class="mt-auto relative z-10">
            <button class="w-full bg-white hover:bg-gray-100 text-[#0b3d2c] px-6 py-3 rounded-full font-semibold transition-all shadow-lg flex items-center justify-center gap-2">
              Pagar
              <div class="w-6 h-6 rounded-full bg-[#0b3d2c] flex items-center justify-center">
                <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
              </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 flex flex-col">
          ...
          <p class="text-gray-600 mb-6 text-xl">2.500 a 4.000 m²</p>
          <div class="mt-auto">
            <button class="w-full bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-full font-semibold transition-all shadow-lg flex items-center justify-center gap-2">
              Pagar
              <div class="w-6 h-6 rounded-full bg-white flex items-center justify-center">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 flex flex-col">
          <h3 class="text-xl font-bold text-gray-900 mb-4">Campo de Deportes</h3>
...
<section id="beneficios" class="py-20 bg-gray-100">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid md:grid-cols-2 gap-12 items-center">
      <div>
        <h2 class="text-2xl lg:text-3xl font-bold text-gray-900 mb-6">Servicios complementarios para tu jardín</h2>
      ...
      <div class="grid md:grid-cols-3 gap-8 lg:gap-12 mb-12">
        ...
        <div>
          ...
          <p class="text-gray-300 mb-4">
            Servicio de mantenimiento de jardines por suscripción mensual. Tu jardín siempre impecable sin preocupaciones.
          </p>
          <p class="text-sm">
        ...
        <div>
          ...
          <div class="space-y-3 mb-6">
            ...
            <p class="text-gray-400 text-sm">
              Servicio disponible de Lunes a Sábado
            </p>
          </div>
